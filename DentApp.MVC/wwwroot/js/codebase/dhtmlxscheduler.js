...
scheduler._click = {
    ...
    dhx_cal_prev_button: function() {
        ...
        scheduler.callEvent("onChangeMonthClicked", [])
    },
    ...
    if (this._drag_mode) {
        ...
        if (t.force_redraw || this._is_pos_changed(this._drag_pos, t)) {
            ...
            if ("move" == this._drag_mode)
                ...
                t._ignores && this.config.preserve_length && this._table_view ? (this.matrix && (d = this.matrix[this._mode]),
                d = d || {
                    x_step: 1,
                    x_unit: "day"
                },
                ...
                this._table_view) {
                    ...
                    if ("month" == this._mode)
                        ...
                        t.resize_from_start ? i = l : s = l
                } else
                    s = this.date.date_part(new Date(o.end_date.valueOf() - 1)).valueOf() + t.y * this.config.time_step * 6e4,
                ...
                if ("new-size" == this._drag_mode)
                    if (s <= this._drag_start) {
                        ...
                        i = s - (t.shift ? 0 : _),
                        s = this._drag_start + (_ || 6e4 * this.config.time_step)
                    } else
                        i = this._drag_start;
                else
            ...
            if (scheduler.config.limit_drag_out && (+u < +scheduler._min_date || +s > +scheduler._max_date)) {
                var g = s - u;
                +u < +scheduler._min_date ? (u = new Date(scheduler._min_date),
                s = new Date(+u + g)) : (s = new Date(scheduler._max_date),
                u = new Date(+s - g));
                var c = new Date(s - 1)
            }
            if (!this._table_view && !scheduler.config.all_timed && (!scheduler._get_section_view() && t.x != this._get_event_sday({
                ...
                c = new Date(s - 1),
                "move" == this._drag_mode && (u = new Date(+s - g))
            }
            if (this._table_view || c.getDate() == u.getDate() && c.getHours() < this.config.last_hour || scheduler._allow_dnd)
                ...
                this.config.update_render) {
                    ...
                    this.update_view(),
                    scheduler._els.dhx_cal_data[0].scrollTop = f
                } else
...
scheduler._on_mouse_up = function(e) {
    if (!e || 2 != e.button || !scheduler.config.touch) {
        if (this._drag_mode && this._drag_id) {
            ...
            this._drag_pos && (this._drag_pos.has_moved || this._drag_pos === !0) && this.render_view_data(),
...
scheduler._render_month_scale = function(e, t, i) {
    ...
    for (var _ = 0, c = "<table cellpadding='0' cellspacing='0'>", u = [], l = 0; d > l; l++) {
        ...
        for (var g = Math.max(s(l) - scheduler.xy.month_head_height, 0), f = 0; 7 > f; f++) {
            c += "<td";
            var v = "";
            t > i ? v = "dhx_before" : i >= a ? v = "dhx_after" : i.valueOf() == r.valueOf() && (v = "dhx_now"),
            this._ignores_detected && this._ignores[f] && (v += " dhx_scale_ignore"),
            c += " class='" + v + " " + this.templates.month_date_class(i, r) + "' >";
            var m = "dhx_month_body"
              , p = "dhx_month_head";
            0 === f && this.config.left_border && (m += " dhx_month_body_border",
            p += " dhx_month_head_border"),
            this._ignores_detected && this._ignores[f] ? c += "<div></div><div></div>" : (c += "<div class='" + p + "'>" + this.templates.month_day(i) + "</div>",
            c += "<div class='" + m + "' " + o[f] + ";height:" + g + "px;'></div></td>"),
            u.push(i);
            var x = i.getDate();
            i = this.date.add(i, 1, "day"),
            i.getDate() - x > 1 && (i = new Date(i.getFullYear(),i.getMonth(),x + 1,12,0));
        }
        c += "</tr>",
...
scheduler._get_real_event_length = function(e, t, i) {
    ...
    for (i.render ? (d = this._get_date_index(i, e),
    s = this._get_date_index(i, t)) : s = Math.round(a / 60 / 60 / 1e3 / 24); s > d; ) {
...
scheduler.date = {
    ...
    _add_days: function(e, t) {
        ...
        t >= 0 && !e.getHours() && i.getHours() && (i.getDate() < e.getDate() || i.getMonth() < e.getMonth() || i.getFullYear() < e.getFullYear()) && i.setTime(i.getTime() + 36e5 * (24 - i.getHours())),
        i
    },
    add: function(e, t, i) {
    ...
    str_to_date: function(e, t) {
        ...
        return t && (n = " Date.UTC(" + n + ")"),
        new Function("date","var set=[0,0,1,0,0,0]; " + i + " return new Date(" + n + ");")
    },
...
scheduler.showEvent = function(e, t) {
    ...
    i && (!this.checkEvent("onBeforeEventDisplay") || this.callEvent("onBeforeEventDisplay", [i, t]))) {
        ...
        var n = i.color
          , r = i.textColor;
        scheduler.config.highlight_displayed_event && (i.color = scheduler.config.displayed_event_color,
        ...
        scheduler.matrix && scheduler.matrix[t] && (scheduler._els.dhx_cal_data[0].scrollTop = getAbsoluteTop(scheduler.getRenderedEvent(i.id)) - getAbsoluteTop(scheduler._els.dhx_cal_data[0]) - 20),
...
scheduler._dp_init = function(e) {
    e._methods = ["_set_event_text_style", "", "changeEventId", "_dp_hook_delete"],
    this._dp_hook_delete = function(e) {
    ...
    e._getRowData = function(e, t) {
        var i = this.obj.getEvent(e)
          , s = {};
        for (var a in i)
            0 !== a.indexOf("_") && (i[a] && i[a].getUTCFullYear ? s[a] = this.obj.templates.xml_format(i[a]) : s[a] = i[a]);
        return s
    }
    ,
